...
- **⚙️ Stepper Motor Control**: Precise bin positioning using TB6600 driver with NEMA 23 stepper motor (19kg/cm holding torque) - 4 bin positions (0, 1100, 2050, 3000 steps)
