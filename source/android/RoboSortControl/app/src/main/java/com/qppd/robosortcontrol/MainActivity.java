...
public class MainActivity extends AppCompatActivity {
    ...
    private MaterialButton btnLookMinus10, btnLookMinus5, btnLookPlus5, btnLookPlus10;
    ...
    private static final int STEP_LOOK_LARGE = 10;
    private static final int STEP_LOOK_SMALL = 5;
    ...
    private void initializeUI() {
        ...
        btnLookMinus10 = findViewById(R.id.btnLookMinus10);
        btnLookMinus5 = findViewById(R.id.btnLookMinus5);
    ...
    private void setupServoControls() {
        ...
        // LOOK: +/- 10
        btnLookMinus10.setOnClickListener(v -> {
            servo5Pos -= STEP_LOOK_LARGE;
            servo5Pos = Math.max(0, Math.min(180, servo5Pos));
            servo5Label.setText(String.format(Locale.US, "LOOK (S5): %d°", servo5Pos));
            sendServoCommand(5, servo5Pos);
        });

        btnLookPlus10.setOnClickListener(v -> {
            servo5Pos += STEP_LOOK_LARGE;
            servo5Pos = Math.max(0, Math.min(180, servo5Pos));
            servo5Label.setText(String.format(Locale.US, "LOOK (S5): %d°", servo5Pos));
            sendServoCommand(5, servo5Pos);
        ...
        // LOOK: +/- 5
        btnLookMinus5.setOnClickListener(v -> {
            servo5Pos -= STEP_LOOK_SMALL;
            servo5Pos = Math.max(0, Math.min(180, servo5Pos));
            servo5Label.setText(String.format(Locale.US, "LOOK (S5): %d°", servo5Pos));
            sendServoCommand(5, servo5Pos);
        });

        btnLookPlus5.setOnClickListener(v -> {
            servo5Pos += STEP_LOOK_SMALL;
            servo5Pos = Math.max(0, Math.min(180, servo5Pos));
            servo5Label.setText(String.format(Locale.US, "LOOK (S5): %d°", servo5Pos));
            sendServoCommand(5, servo5Pos);
