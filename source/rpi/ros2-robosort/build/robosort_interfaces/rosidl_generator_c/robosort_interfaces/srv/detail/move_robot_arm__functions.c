...
robosort_interfaces__srv__MoveRobotArm_Request__init(robosort_interfaces__srv__MoveRobotArm_Request * msg)
{
  ...
  if (!rosidl_runtime_c__float__Sequence__init(&msg->joint_angles, 0)) {
    robosort_interfaces__srv__MoveRobotArm_Request__fini(msg);
    return false;
  }
  return true;
}
...
robosort_interfaces__srv__MoveRobotArm_Request__create(void)
{
  ...
  robosort_interfaces__srv__MoveRobotArm_Request * msg = (robosort_interfaces__srv__MoveRobotArm_Request *)allocator.allocate(sizeof(robosort_interfaces__srv__MoveRobotArm_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(robosort_interfaces__srv__MoveRobotArm_Request));
  bool success = robosort_interfaces__srv__MoveRobotArm_Request__init(msg);
  if (!success) {
...
robosort_interfaces__srv__MoveRobotArm_Request__Sequence__init(robosort_interfaces__srv__MoveRobotArm_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robosort_interfaces__srv__MoveRobotArm_Request * data = NULL;

  if (size) {
    data = (robosort_interfaces__srv__MoveRobotArm_Request *)allocator.zero_allocate(size, sizeof(robosort_interfaces__srv__MoveRobotArm_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = robosort_interfaces__srv__MoveRobotArm_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        robosort_interfaces__srv__MoveRobotArm_Request__fini(&data[i - 1]);
      }
...
robosort_interfaces__srv__MoveRobotArm_Request__Sequence__fini(robosort_interfaces__srv__MoveRobotArm_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      robosort_interfaces__srv__MoveRobotArm_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robosort_interfaces__srv__MoveRobotArm_Request__Sequence * array = (robosort_interfaces__srv__MoveRobotArm_Request__Sequence *)allocator.allocate(sizeof(robosort_interfaces__srv__MoveRobotArm_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = robosort_interfaces__srv__MoveRobotArm_Request__Sequence__init(array, size);
  if (!success) {
...
robosort_interfaces__srv__MoveRobotArm_Request__Sequence__destroy(robosort_interfaces__srv__MoveRobotArm_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    robosort_interfaces__srv__MoveRobotArm_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
robosort_interfaces__srv__MoveRobotArm_Request__Sequence__are_equal(const robosort_interfaces__srv__MoveRobotArm_Request__Sequence * lhs, const robosort_interfaces__srv__MoveRobotArm_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!robosort_interfaces__srv__MoveRobotArm_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  robosort_interfaces__srv__MoveRobotArm_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(robosort_interfaces__srv__MoveRobotArm_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    robosort_interfaces__srv__MoveRobotArm_Request * data =
      (robosort_interfaces__srv__MoveRobotArm_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!robosort_interfaces__srv__MoveRobotArm_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          robosort_interfaces__srv__MoveRobotArm_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!robosort_interfaces__srv__MoveRobotArm_Request__copy(
...
robosort_interfaces__srv__MoveRobotArm_Response__init(robosort_interfaces__srv__MoveRobotArm_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->message)) {
    robosort_interfaces__srv__MoveRobotArm_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robosort_interfaces__srv__MoveRobotArm_Response * msg = (robosort_interfaces__srv__MoveRobotArm_Response *)allocator.allocate(sizeof(robosort_interfaces__srv__MoveRobotArm_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(robosort_interfaces__srv__MoveRobotArm_Response));
  bool success = robosort_interfaces__srv__MoveRobotArm_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
robosort_interfaces__srv__MoveRobotArm_Response__Sequence__init(robosort_interfaces__srv__MoveRobotArm_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robosort_interfaces__srv__MoveRobotArm_Response * data = NULL;

  if (size) {
    data = (robosort_interfaces__srv__MoveRobotArm_Response *)allocator.zero_allocate(size, sizeof(robosort_interfaces__srv__MoveRobotArm_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = robosort_interfaces__srv__MoveRobotArm_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        robosort_interfaces__srv__MoveRobotArm_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
robosort_interfaces__srv__MoveRobotArm_Response__Sequence__fini(robosort_interfaces__srv__MoveRobotArm_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      robosort_interfaces__srv__MoveRobotArm_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robosort_interfaces__srv__MoveRobotArm_Response__Sequence * array = (robosort_interfaces__srv__MoveRobotArm_Response__Sequence *)allocator.allocate(sizeof(robosort_interfaces__srv__MoveRobotArm_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = robosort_interfaces__srv__MoveRobotArm_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
robosort_interfaces__srv__MoveRobotArm_Response__Sequence__destroy(robosort_interfaces__srv__MoveRobotArm_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    robosort_interfaces__srv__MoveRobotArm_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
robosort_interfaces__srv__MoveRobotArm_Response__Sequence__are_equal(const robosort_interfaces__srv__MoveRobotArm_Response__Sequence * lhs, const robosort_interfaces__srv__MoveRobotArm_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!robosort_interfaces__srv__MoveRobotArm_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  robosort_interfaces__srv__MoveRobotArm_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(robosort_interfaces__srv__MoveRobotArm_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    robosort_interfaces__srv__MoveRobotArm_Response * data =
      (robosort_interfaces__srv__MoveRobotArm_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!robosort_interfaces__srv__MoveRobotArm_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          robosort_interfaces__srv__MoveRobotArm_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!robosort_interfaces__srv__MoveRobotArm_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
robosort_interfaces__srv__MoveRobotArm_Event__init(robosort_interfaces__srv__MoveRobotArm_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    robosort_interfaces__srv__MoveRobotArm_Event__fini(msg);
    return false;
  }
  // request
  if (!robosort_interfaces__srv__MoveRobotArm_Request__Sequence__init(&msg->request, 0)) {
    robosort_interfaces__srv__MoveRobotArm_Event__fini(msg);
    return false;
  }
  // response
  if (!robosort_interfaces__srv__MoveRobotArm_Response__Sequence__init(&msg->response, 0)) {
    robosort_interfaces__srv__MoveRobotArm_Event__fini(msg);
    return false;
  }
  return true;
...
robosort_interfaces__srv__MoveRobotArm_Event__fini(robosort_interfaces__srv__MoveRobotArm_Event * msg)
{
  ...
  // request
  robosort_interfaces__srv__MoveRobotArm_Request__Sequence__fini(&msg->request);
  // response
  robosort_interfaces__srv__MoveRobotArm_Response__Sequence__fini(&msg->response);
}
...
robosort_interfaces__srv__MoveRobotArm_Event__are_equal(const robosort_interfaces__srv__MoveRobotArm_Event * lhs, const robosort_interfaces__srv__MoveRobotArm_Event * rhs)
{
  ...
  // request
  if (!robosort_interfaces__srv__MoveRobotArm_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!robosort_interfaces__srv__MoveRobotArm_Response__Sequence__are_equal(
  ...
  robosort_interfaces__srv__MoveRobotArm_Event * output)
{
  ...
  // request
  if (!robosort_interfaces__srv__MoveRobotArm_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!robosort_interfaces__srv__MoveRobotArm_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robosort_interfaces__srv__MoveRobotArm_Event * msg = (robosort_interfaces__srv__MoveRobotArm_Event *)allocator.allocate(sizeof(robosort_interfaces__srv__MoveRobotArm_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(robosort_interfaces__srv__MoveRobotArm_Event));
  bool success = robosort_interfaces__srv__MoveRobotArm_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
robosort_interfaces__srv__MoveRobotArm_Event__Sequence__init(robosort_interfaces__srv__MoveRobotArm_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robosort_interfaces__srv__MoveRobotArm_Event * data = NULL;

  if (size) {
    data = (robosort_interfaces__srv__MoveRobotArm_Event *)allocator.zero_allocate(size, sizeof(robosort_interfaces__srv__MoveRobotArm_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = robosort_interfaces__srv__MoveRobotArm_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        robosort_interfaces__srv__MoveRobotArm_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
robosort_interfaces__srv__MoveRobotArm_Event__Sequence__fini(robosort_interfaces__srv__MoveRobotArm_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      robosort_interfaces__srv__MoveRobotArm_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robosort_interfaces__srv__MoveRobotArm_Event__Sequence * array = (robosort_interfaces__srv__MoveRobotArm_Event__Sequence *)allocator.allocate(sizeof(robosort_interfaces__srv__MoveRobotArm_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = robosort_interfaces__srv__MoveRobotArm_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
robosort_interfaces__srv__MoveRobotArm_Event__Sequence__destroy(robosort_interfaces__srv__MoveRobotArm_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    robosort_interfaces__srv__MoveRobotArm_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
robosort_interfaces__srv__MoveRobotArm_Event__Sequence__are_equal(const robosort_interfaces__srv__MoveRobotArm_Event__Sequence * lhs, const robosort_interfaces__srv__MoveRobotArm_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!robosort_interfaces__srv__MoveRobotArm_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  robosort_interfaces__srv__MoveRobotArm_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(robosort_interfaces__srv__MoveRobotArm_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    robosort_interfaces__srv__MoveRobotArm_Event * data =
      (robosort_interfaces__srv__MoveRobotArm_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!robosort_interfaces__srv__MoveRobotArm_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          robosort_interfaces__srv__MoveRobotArm_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!robosort_interfaces__srv__MoveRobotArm_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
