...
static const _SetServo_Request_type_support_symbol_names_t _SetServo_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robosort_interfaces, srv, SetServo_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robosort_interfaces, srv, SetServo_Request)),
  }
};
...
{
  return &::robosort_interfaces::srv::rosidl_typesupport_cpp::SetServo_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robosort_interfaces, srv, SetServo_Request)() {
  return get_message_type_support_handle<robosort_interfaces::srv::SetServo_Request>();
}
...
static const _SetServo_Response_type_support_symbol_names_t _SetServo_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robosort_interfaces, srv, SetServo_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robosort_interfaces, srv, SetServo_Response)),
  }
};
...
{
  return &::robosort_interfaces::srv::rosidl_typesupport_cpp::SetServo_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robosort_interfaces, srv, SetServo_Response)() {
  return get_message_type_support_handle<robosort_interfaces::srv::SetServo_Response>();
}
...
static const _SetServo_Event_type_support_symbol_names_t _SetServo_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robosort_interfaces, srv, SetServo_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robosort_interfaces, srv, SetServo_Event)),
  }
};
...
{
  return &::robosort_interfaces::srv::rosidl_typesupport_cpp::SetServo_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robosort_interfaces, srv, SetServo_Event)() {
  return get_message_type_support_handle<robosort_interfaces::srv::SetServo_Event>();
}
...
static const _SetServo_type_support_symbol_names_t _SetServo_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robosort_interfaces, srv, SetServo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robosort_interfaces, srv, SetServo)),
  }
};
...
static const rosidl_service_type_support_t SetServo_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<robosort_interfaces::srv::SetServo_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<robosort_interfaces::srv::SetServo_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<robosort_interfaces::srv::SetServo_Event>(),
...
{
  return &::robosort_interfaces::srv::rosidl_typesupport_cpp::SetServo_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, robosort_interfaces, srv, SetServo)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<robosort_interfaces::srv::SetServo>();
}
